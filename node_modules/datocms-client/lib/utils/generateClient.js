...
var findLinkFor = function findLinkFor(schema, namespace, apiCall) {
  var singularized = (0, _humps.decamelize)((0, _pluralize.singular)(namespace));
            ...
            return function call() {
              ...
              return schemaPromise.then( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(schema) {
                  var singularized, link, lastUrlId, url, body, queryString, options, deserializeResponse, deserialize, serializeRequest, _fetchRequest, _fetchRequest2, _fetchRequest3, allPages, perPage, request, fetchRequest;

                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          singularized = (0, _humps.decamelize)((0, _pluralize.singular)(namespace));
                        ...
                        case 27:
                          ...
                          request = (0, _fetchAllPages["default"])(rawClient, url, queryString, perPage);
